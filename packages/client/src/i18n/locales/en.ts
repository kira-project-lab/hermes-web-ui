export default {
  ...
  settings: {
    ...
    dev: {
      enabled: 'Enable Dev Mode',
      enabledHint: 'Allow admin users to manage branch preview builds',
      warningTitle: 'Security warning',
      warningBody: 'Branch builds execute code from the selected branch inside an isolated worktree. Keep Dev Mode disabled unless you trust the repository and understand the risk.',
      reviewBase: 'Review Base',
      reviewBaseHint: 'Shared base branch used to reset the preview target',
      reviewBasePlaceholder: 'Select review base branch',
      previewBranch: 'Preview Branch',
      previewBranchHint: 'Current branch selected for preview/build',
      previewBranchPlaceholder: 'Select preview branch',
      refresh: 'Refresh status',
      refreshBranches: 'Refresh branches',
      branchPreviewTitle: 'Branch Preview',
      availableBranches: 'Available branches',
      branchPlaceholder: 'Select a branch to build',
      branchRequired: 'Please select a branch first',
      previewNow: 'Preview target',
      buildBranch: 'Built branch',
      worktreePath: 'Worktree path',
      buildBranchAction: 'Build selected branch',
      resetPreview: 'Reset preview to review base',
      ...
      disabledNote: 'Dev Mode is currently disabled. Select branches, enable Dev Mode, then save settings before building or resetting previews.',
      permissionTitle: 'Super administrator required',
      permissionBody: 'Dev Mode can only be changed by a super administrator.',
    },
    apiServer: {
      enable: 'Enable',
